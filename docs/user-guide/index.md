...
The cluster navigator on the left side of the interface
provides tree-based navigation across groups, clusters,
and individual servers. Select a node in the navigator
to view dashboards, alerts, and AI insights for that
scope.
