...
// actingTokenID returns the id of the token that made the request,
// which AuthenticateRequest and AuthMiddleware both record under
// TokenIDContextKey, or zero for a session.
