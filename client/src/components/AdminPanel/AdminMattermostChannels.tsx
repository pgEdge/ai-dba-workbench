...
const AdminMattermostChannels: React.FC = () => {
    ...
    const [editingChannel, setEditingChannel] = useState<MattermostChannel | null>(null);
    ...
    const [deleteChannel, setDeleteChannel] = useState<MattermostChannel | null>(null);
    ...
    const fetchChannels = useCallback(async () => {
        try {
            ...
            const mattermostChannels: MattermostChannel[] = allChannels
                .filter((ch: Record<string, unknown>) => ch.channel_type === 'mattermost')
    ...
    const handleOpenEdit = (e: React.MouseEvent, channel: MattermostChannel) => {
        e.stopPropagation();
    ...
    const handleOpenDelete = (e: React.MouseEvent, channel: MattermostChannel) => {
        e.stopPropagation();
    ...
    const handleToggleEnabled = async (channel: MattermostChannel) => {
        try {
            const response = await fetch(
    ...
    const handleTestChannel = async (e: React.MouseEvent, channel: MattermostChannel) => {
        e.stopPropagation();
        try {
        ...
        <Box>
            ...
            >
                <DialogTitle sx={dialogTitleSx}>
                    {isEditing ? `Edit Channel: ${editingChannel.name}` : 'Create Mattermost Channel'}
                </DialogTitle>
                <DialogContent>
                    {dialogError && (
            ...
            <DeleteConfirmationDialog
                ...
                title="Delete Mattermost Channel"
                message="Are you sure you want to delete the Mattermost channel"
