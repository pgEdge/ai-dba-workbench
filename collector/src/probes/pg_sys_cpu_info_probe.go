...
func (p *PgSysCPUInfoProbe) GetName() string {
	return ProbeNamePgSysCPUInfo
}
...
func (p *PgSysCPUInfoProbe) GetTableName() string {
	return ProbeNamePgSysCPUInfo
}

// IsDatabaseScoped returns false as pg_sys_cpu_info is server-scoped
func (p *PgSysCPUInfoProbe) IsDatabaseScoped() bool {
	return false
}
...
func (p *PgSysCPUInfoProbe) Execute(ctx context.Context, connectionName string, monitoredConn *pgxpool.Conn, pgVersion int) ([]map[string]interface{}, error) {
...
func (p *PgSysCPUInfoProbe) Store(ctx context.Context, datastoreConn *pgxpool.Conn, connectionID int, timestamp time.Time, metrics []map[string]interface{}) error {
	if len(metrics) == 0 {
