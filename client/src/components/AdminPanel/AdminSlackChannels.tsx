...
const AdminSlackChannels: React.FC = () => {
    ...
    const [deleteChannel, setDeleteChannel] = useState<SlackChannel | null>(null);
    ...
    const fetchChannels = useCallback(async () => {
        try {
            ...
            const slackChannels: SlackChannel[] = allChannels
                .filter((ch: Record<string, unknown>) => ch.channel_type === 'slack')
    ...
    const handleOpenEdit = (e: React.MouseEvent, channel: SlackChannel) => {
        e.stopPropagation();
    ...
    const handleOpenDelete = (e: React.MouseEvent, channel: SlackChannel) => {
        e.stopPropagation();
    ...
    const handleToggleEnabled = async (channel: SlackChannel) => {
        try {
            const response = await fetch(
    ...
    const handleTestChannel = async (e: React.MouseEvent, channel: SlackChannel) => {
        e.stopPropagation();
        try {
        ...
        <Box>
            ...
            >
                <DialogTitle sx={dialogTitleSx}>
                    {isEditing ? `Edit Channel: ${editingChannel.name}` : 'Create Slack Channel'}
                </DialogTitle>
                <DialogContent>
                    {dialogError && (
            ...
            <DeleteConfirmationDialog
                ...
                message="Are you sure you want to delete the Slack channel"
