...
describe('classifyExplainSupport', () => {
    const explainable = [
        ...
        'CREATE TABLE t AS -- c\nSELECT 1',
        'CREATE TABLE t AS /* a /* b */ VACUUM */ (SELECT 1)',
        'CREATE TABLE t (a, b) AS /* c */ VALUES (1, 2)',
    ...
    const nonExplainable = [
        ...
        'CREATE TABLE t (a int GENERATED ALWAYS AS /* c */ (1) STORED)',
        'CREATE TABLE t AS /* unterminated SELECT 1',
        'CREATE TABLE t AS -- SELECT 1',
