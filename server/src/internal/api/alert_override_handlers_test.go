...
func TestNewAlertOverrideHandler(t *testing.T) {
	...
	if handler == nil {
		t.Fatal("NewAlertOverrideHandler returned nil")
	}
...
func TestAlertOverrideHandler_HandleNotConfigured(t *testing.T) {
	...
	expectedError := "Alert override management is not available. The datastore is not configured."
	if response.Error != expectedError {
		t.Errorf("Expected error %q, got %q", expectedError, response.Error)
	}
}

func TestAlertOverrideHandler_InvalidScope(t *testing.T) {
	handler := NewAlertOverrideHandler(nil, nil, nil)

	req := httptest.NewRequest(http.MethodGet, "/api/v1/alert-overrides/invalid/1", nil)
	rec := httptest.NewRecorder()
...
func TestAlertOverrideHandler_InvalidScopeID(t *testing.T) {
	handler := NewAlertOverrideHandler(nil, nil, nil)

	req := httptest.NewRequest(http.MethodGet, "/api/v1/alert-overrides/server/abc", nil)
	rec := httptest.NewRecorder()
...
func TestAlertOverrideHandler_InvalidRuleID(t *testing.T) {
	handler := NewAlertOverrideHandler(nil, nil, nil)

	req := httptest.NewRequest(http.MethodPut, "/api/v1/alert-overrides/server/1/abc", nil)
	rec := httptest.NewRecorder()
...
func TestAlertOverrideHandler_ListMethodNotAllowed(t *testing.T) {
	handler := NewAlertOverrideHandler(nil, nil, nil)

	methods := []string{http.MethodPost, http.MethodPut, http.MethodDelete, http.MethodPatch}
	for _, method := range methods {
		req := httptest.NewRequest(method, "/api/v1/alert-overrides/server/1", nil)
		rec := httptest.NewRecorder()
...
func TestAlertOverrideHandler_SubpathMethodNotAllowed(t *testing.T) {
	handler := NewAlertOverrideHandler(nil, nil, nil)

	methods := []string{http.MethodGet, http.MethodPost, http.MethodPatch}
	for _, method := range methods {
		req := httptest.NewRequest(method, "/api/v1/alert-overrides/server/1/2", nil)
		rec := httptest.NewRecorder()
...
func TestAlertOverrideHandler_MissingPathSegments(t *testing.T) {
	handler := NewAlertOverrideHandler(nil, nil, nil)

	paths := []string{
		"/api/v1/alert-overrides/",
		"/api/v1/alert-overrides/server/",
	}
...
func TestAlertOverrideHandler_ExtraPathSegments(t *testing.T) {
	handler := NewAlertOverrideHandler(nil, nil, nil)

	req := httptest.NewRequest(http.MethodGet, "/api/v1/alert-overrides/server/1/2/extra", nil)
	rec := httptest.NewRecorder()
...
func TestAlertOverrideHandler_ValidScopes(t *testing.T) {
	...
	for _, scope := range scopes {
		...
		req := httptest.NewRequest(http.MethodDelete, "/api/v1/alert-overrides/"+scope+"/1/2", nil)
		rec := httptest.NewRecorder()
...
func createTestAuthStoreForAlertOverrides(t *testing.T) (*auth.AuthStore, func()) {
	t.Helper()
	tmpDir, err := os.MkdirTemp("", "alert-override-test-*")
	if err != nil {
...
func TestAlertOverrideHandler_UpsertRequiresPermission(t *testing.T) {
	authStore, cleanup := createTestAuthStoreForAlertOverrides(t)
	defer cleanup()
...
func TestAlertOverrideHandler_DeleteRequiresPermission(t *testing.T) {
	authStore, cleanup := createTestAuthStoreForAlertOverrides(t)
	defer cleanup()
...
func TestAlertOverrideHandler_RegisterRoutes_NotConfigured(t *testing.T) {
	handler := NewAlertOverrideHandler(nil, nil, nil)
	...
	paths := []string{
		...
		"/api/v1/alert-overrides/cluster/2",
		"/api/v1/alert-overrides/group/3",
		"/api/v1/alert-overrides/server/1/5",
	}
...
func TestAlertOverrideHandler_PermissionCheckAllScopes(t *testing.T) {
	authStore, cleanup := createTestAuthStoreForAlertOverrides(t)
	defer cleanup()
