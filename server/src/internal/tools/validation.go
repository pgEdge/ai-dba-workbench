...
func ValidateStringParam(args map[string]any, name string) (string, *mcp.ToolResponse) {
...
func ValidateOptionalStringParam(args map[string]any, name string, defaultValue string) string {
	value, ok := args[name].(string)
	if !ok {
		return defaultValue
	}
...
func ValidateNumberParam(args map[string]any, name string) (float64, *mcp.ToolResponse) {
...
func ValidateOptionalNumberParam(args map[string]any, name string, defaultValue float64) float64 {
	value, ok := args[name].(float64)
	if !ok {
		return defaultValue
	}
...
func ValidateBoolParam(args map[string]any, name string, defaultValue bool) bool {
