...
database connection using the web client.
```
...
| Status | Description |
|--------|-------------|
| 400 | Invalid request (bad connection ID or missing fields). |
...
- [Authentication](managing-users-and-permissions/permission_model.md) covers tokens and
  access control.
