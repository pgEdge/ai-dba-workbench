...
// PreferencesFilename is the name of the preferences file in the user's home directory
const PreferencesFilename = ".ai-dba-workbench-cli-prefs"
...
func GetPreferencesPath() string {
	return filepath.Join(os.Getenv("HOME"), PreferencesFilename)
}
