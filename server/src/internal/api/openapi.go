		...
		"/rbac/users": {
			...
			Post: &OpenAPIOperation{
				...
				Responses: map[string]OpenAPIResponse{
					...
					"400": jsonResponse("ErrorResponse", "Invalid username or email format"),
					"401": jsonResponse("ErrorResponse", "Unauthorized"),
					"403": jsonResponse("ErrorResponse", "Requires manage_users permission"),
					"409": jsonResponse("ErrorResponse", "Username already taken"),
				},
			},
		},
		...
		"/rbac/users/{id}": {
			Put: &OpenAPIOperation{
				...
				Responses: map[string]OpenAPIResponse{
					...
					"400": jsonResponse("ErrorResponse", "Invalid request or email format"),
					"401": jsonResponse("ErrorResponse", "Unauthorized"),
					"403": jsonResponse("ErrorResponse", "Requires manage_users permission"),
